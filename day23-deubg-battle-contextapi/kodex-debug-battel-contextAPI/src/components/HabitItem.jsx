...
const HabitItem = ({ habit }) => {
  ...
  const motivation =
    habit.motivation?.trim() || "Stay consistent and keep moving.";
      ...
      <div className="space-y-4">
        <div className="flex items-start justify-between">
          ...
          <div className="ml-4 text-right">
            <div className="flex items-center justify-end text-slate-700">
              ...
              <span className="ml-1 text-xs font-black text-orange-500">
                ^^
              </span>
            </div>
        ...
        <div className="flex items-center justify-between border-t border-slate-100 pt-4">
          <div className="text-xs">
            <span className="block font-medium uppercase text-slate-400">
              Goal
            </span>
