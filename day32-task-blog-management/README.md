...
• Node.js (for development) 3. Functional Requirements
...
updateBlog: fn,
deleteBlog: fn
3.6 Local Storage Integration 4.
On app load:
...
• Clean folder organization 5. System Design
...
• Edit/Delete buttons
5.3 Context Flow
User Action Component → Context Function State Update UI Re-render 6. Data Flow
...
7. UI Requirements • Clean card-based layout
   • Buttons:
   • Add
   • Edit
   • Delete
